...
2. Fase de Resumo e Aprovação:
   ...
   <summary>
   Com base em nossa discussão, aqui está meu entendimento dos requisitos da feature:
   [Forneça um resumo conciso da feature, seus objetivos e requisitos principais]
...
3. Criando o Arquivo Markdown:
   ...
   ## POR QUE
   [Liste as razões para construir esta feature]

   ## O QUE
   [Descreva o que precisa ser construído ou modificado -- inclua features existentes que serão afetadas]

   ## COMO
   [Forneça quaisquer detalhes extras que possam ser úteis para um Desenvolvedor IA]
   </markdown>

   Lembre-se, a audiência para este artefato é um Desenvolvedor IA com capacidades e contexto similares ao seu. Seja conciso mas forneça informações suficientes para que a IA entenda e prossiga com a tarefa.
