...
This is a documentation project for several open source projects for our organization. The idea for this repo is to be the one specification that drives all other specs, code, desenho and test artifacts. It is our canonical source of truth for all our projects.
