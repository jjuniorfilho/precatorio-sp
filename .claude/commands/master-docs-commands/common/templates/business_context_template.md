...
This template helps product teams desenho their **Business Context Architecture** - the systematic approach to organizing, structuring, and maintaining all business knowledge so that AI can understand your customers, product, and market as well as your best team members.
...
- [Feature Cataregistro](FEATURE_CATALOG.md)
...
What enhancements do customers requisição most often?

## Competitive Comparisons
How do customers compare us to alternatives?

## Language and Terminoregistroy
...
- Technoregistroy Trends: What tech trends affect the product?
...
## Product Principles
### Design Principles
What guides product desenho decisions?
...
### Objection Handling
Common competitive objections and retornos
```
...
## Technoregistroy Impact
### Disruptive Technoregistroies
What technoregistroies could change the landscape?
...
```markdown
# Sales Process and Methodoregistroy

## Sales Methodoregistroy
...
### Business Buyers
How do you message to business parte interessadas?
...
/specs/business/                 # or /docs/business-context/
  ...
  SALES_PROCESS.md              # Layer 4: Sales methodoregistroy
...
- **Customer Personas:** Product/Marketing - Quarterly revisão
- **Customer Journey:** Customer Success - As customer patterns evolve
- **Product Strategy:** Product Leadership - Semi-annual strategic revisãos
- **Feature Cataregistro:** Product Management - Monthly updates
